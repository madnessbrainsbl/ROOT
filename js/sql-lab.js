  ...
  function renderExplorer() {
    ...
    return `
      <div class="hero">
        ...
        <p>${en
          ? 'SQLite is the source of truth. Table <code>zero_days</code> holds the Zero-Day/KEV catalog — add rows with INSERT or the form on Zero-Days page. Changes are saved to localStorage (survive F5).'
          : 'SQLite — источник правды. Таблица <code>zero_days</code> — каталог Zero-Day/KEV: добавляй через INSERT или форму на странице Zero-Days. Изменения пишутся в localStorage (переживают F5).'}</p>
        <div class="stat-grid">
